...
describe CategoriesChart do
  ...
  describe ".credits and .debits" do
    before(:each) do
      @categories_chart.stub(:from).and_return(Date.parse('2010-1-1'))
      @categories_chart.stub(:to).and_return(Date.parse('2010-3-31'))
      grouped_expenses = [
        mock(:beginning_of_month => '2010-1-1', :credit => 10.0, :debit => 1.0, :main_category => 'Foo', :subcategory => 'Baz'),
        mock(:beginning_of_month => '2010-1-1', :credit => 10.0, :debit => 2.0, :main_category => 'Foo', :subcategory => 'Baz'),
        mock(:beginning_of_month => '2010-1-1', :credit => 15.0, :debit => 3.0, :main_category => 'Foo', :subcategory => 'Qux'),
        mock(:beginning_of_month => '2010-2-1', :credit => 1.0, :debit => 4.0, :main_category => nil, :subcategory => nil),
        mock(:beginning_of_month => '2010-3-1', :credit => 20.0, :debit => 5.0, :main_category => 'Foo', :subcategory => 'Baz'),
        mock(:beginning_of_month => '2010-3-1', :credit => 30.0, :debit => 6.0, :main_category => 'Foo', :subcategory => 'Baz'),
        mock(:beginning_of_month => '2010-3-1', :credit => 30.0, :debit => 7.0, :main_category => 'Foo', :subcategory => 'Qux'),
        mock(:beginning_of_month => '2010-3-1', :credit => 30.0, :debit => 8.0, :main_category => 'Foo', :subcategory => 'Qux')
        ]
      @categories_chart.stub(:grouped_expenses).and_return(grouped_expenses)
    end
